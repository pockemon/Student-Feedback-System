                                ...
                                <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="Mobile Number"value="<?php echo @$res['mobile'];?>" maxlength="10" name="mob"  required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                  ...
                                                  <div class="form-group">
                                                    <label>Program</label>
                                                    <select class="form-control" id="inputProgram" style="font-size: 16px" placeholder="Program" name="prg" value="<?php echo @$res['programme'];?>" >
